...
- **AI**: Gemini 2.0 Flash（$0.012円/社、2回目以降はキャッシュで0円）
...
| 項目 | 料金 | 備考 |
|------|------|------|
| Input | $0.00001875 / 1K tokens | プロンプト + HTML |
| Output | $0.000075 / 1K tokens | JSON出力 |
...
- プロンプト: 300トークン
- HTML: 5,010トークン
- 合計: 5,310トークン × $0.00001875 = $0.0001

【出力】
- JSON: 600トークン × $0.000075 = $0.000045

【合計】
$0.0001446 ≈ 0.012円/社（初回のみ）
```
