...
flowchart TB
    subgraph DeepBiz["DeepBiz Platform<br/>企業データ収集・分析基盤"]
        ...
        subgraph Phase2["Phase 2: 企業分析（AI使用）"]
            P2A["🤖 Gemini 2.0 Flash<br/>非構造化テキスト → 構造化JSON<br/>事業内容・強み・課題・ターゲット顧客抽出<br/>コスト: 0.023円/社（初回のみ）"]
        end
...
|---------|---------|---------|------|------|
| **DeepBiz** | 企業分析 | **Gemini 2.0 Flash** | **0.023円/社** | 初回のみ |
...
| AIモデル | 使用箇所 | 単価 | 選定理由 |
|---------|---------|------|---------|
| **Gemini 2.0 Flash** | DeepBiz: 企業分析 | 0.023円/社 | 最安コスト + 高速処理 + 高精度 |
...
| AI モデル | 1社コスト | Gemini 2.0 Flashとの差 |
|----------|----------|----------------------|
| GPT-4 | 63円 | **2,739倍高い** |
| GPT-3.5 Turbo | 1.4円 | 61倍高い |
| Claude 3 Haiku | 0.13円 | 6倍高い |
| **Gemini 2.0 Flash** | **0.023円** | ✅ **最安** |

**結論**: DeepBizでは最安のGemini 2.0 Flashを選定し、データ基盤のコストを最小化
